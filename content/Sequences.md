...
Related: [[Convergent sequences of functions]], [[Bounded sets and functions#Bounded sequences|Bounded sequences]]
...
>Let $A$ be the set of [[Limits and accumulation points|limits]] of subsequences of a [[Sequences|sequence]] $(x_n)_{n \in \mathbb N}$ in $\mathbb R$. Then $A$ is [[Closed sets and closures|closed]].
