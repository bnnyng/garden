...
>$$
>where $f_\alpha: Z \to X_\alpha$ is the **coordinate function** $f_\alpha : \pi_\alpha \circ f$. If $\prod_{\alpha \in J} X_\alpha$ has the [[Product spaces|product topology]], then $f$ is [[Pointwise continuity|continuous]] if and only if each $f_\alpha$ is continuous.
