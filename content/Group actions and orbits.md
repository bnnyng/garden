...
lastmod: 2025-02-19T12:35:54-05:00
---
# Overview and basic definition

>[!example] Definition: Group action
...
>$$ \alpha(x, e ) = x \quad \quad \alpha( g_2, \alpha(g_1, x)) = \alpha(g_1g_2, x) $$ for all $x \in X$ and $g_1, g_2 \in G$. The action of an element $g \in G$ is often denoted $\alpha(g, x) = g \cdot x$, in which case the axioms above read $e \cdot x = x$ and $(g_1g_2) \cdot x = g_2 \cdot (g_1 \cdot x)$.

>[!example] Definition: Orbit
