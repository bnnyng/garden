...
The $n$-dimensional sphere and disks are defined by… respectively
...
- [[Homeomorphisms and topological embeddings]]: We have several useful **homeomorphisms**:
	- $S^n \cong D^n / S^{n-1}$;
	- $S^n \backslash \{ N \} \cong \mathbb R^n$ via **stereographic projection**, where $S^n \backslash \{ N \}$ is the sphere with one point removed;

---
# In algebraic topology

- [[Homotopy equivalence]]: We have several useful **homotopy equivalences**:
