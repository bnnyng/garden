...
lastmod: 2025-02-22T18:08:08-05:00
---
# In metric spaces
...
>[!example] Definition: Locally path-connected
>A topological space $X$ is **locally path-connected** if, given a point $x \in X$ and any neighborhood $U \subseteq X$ of $x$, there exists a neighborhood $V \subseteq U$ such that $V$ is path-connected.
>
>Equivalently, any path component of any open subset of $X$ is itself open. This condition is often paraphrased by saying that every $x \in X$ has “arbitrarily small” path-connected neighborhoods.
