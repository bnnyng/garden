...
>An **ordered set** $(X, <)$ is a [[20250128-axioms-of-naive-set-theory|set]] $X$ together with a relation $<$, 

>[!example] Definition: Ordered field
>An **ordered field** $(\mathbb F, + , \cdot, <)$ is a [[Axiomatic definition of fields|field]] $(\mathbb F, + , \cdot)$ with an order $<$ *on* $\mathbb F$ so that we have:
