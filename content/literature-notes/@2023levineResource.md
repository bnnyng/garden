---
citekey: 2023levineResourcerational
aliases: 
tags:
  - literature-note
title: "Journal Article | Resource-rational contractualism: A triple theory of moral cognition"
year: 2023
...
- [[Many action- and value-based moral judgments are resource-rational approximations of agreement-based moral judgments, after Levine et al. (2023)]]

---

# Key terms

- **Ad hoc:** done as necessary.
- **Mutual benefit:** an outcome or arrangement involving multiple parties that makes each party involved better off than they would be otherwise; in more formal **bargaining theory**, “the specific agreement that rational agents would come to, leaving both better off” (6).
- **Contractualism:** broadly, any theory that “derives moral permissibility from some form of agreement” (10).
- **Consequentialism:** the theory that the moral properties of an action depend on the “state of affairs” or consequences that it brings about. 
...
- **Morality exists to guide people with competing interests towards agreements of mutual benefit:** “Across the many disciplines that study human morality—psychology, anthropology, economics, biology—there is widespread consensus about the function of morality. Humans have diverse interests and goals, and each person’s success at achieving their goals depends on decisions made by others. We must, then, figure out individually and collectively how to adjudicate our competing interests. Morality helps us solve this problem (Greene 2014; Haidt 2007; Gauthier 1987; Rawls 1971; Bicchieri 2005; Curry 2016; Binmore 2005; Baumard, André, and Sperber 2013; Tomasello 2009).”

>Starting with the premise that the ultimate function of morality is to guide interdependent choice, we argue that the proximate mechanisms of our moral psychology can be usefully organized around the concept of agreement—the creation and application of “contracts”, formal or informal, between people. (3)

## Limitations of the framework

- **The bargaining framework only applies to moral judgments about *interdependent* choice (i.e., interacting utilities of multiple agents):** 
	- “For instance, sometimes people condemn *“victimless” crimes* (such as consensual incest (Haidt, Koller, and Dias 1993) or the eating of certain foods (Levine, Rottman, et al. 2020)) as morally wrong, which our account does not explain.”
...
>At the broadest level, philosophical contractualism posits that human agreements, institutions, and rules ought to be modeled on what rational agents should agree to in order to achieve mutual benefit. (10)

## Mechanisms of resource-rational moral cognition

#### Model-based contractualist cognition

**Implied valuation (bargaining over welfare standards)**

- **People’s decision-making considers others’ *responses* to the implied value assigned to welfare:** “When we make choices, we often consider whether those choices would make others feel as if we value them sufficiently. And this make sense, given that people do in fact interpret social behavior not just in light of its immediate, local consequences, but also in terms of the way it signals a more global valuation—how much they are cared for in general (Shaw 2013; McManus, Kleiman-Weiner, and Young 2020; Uhlmann, Pizarro, and Diermeier 2015; Adams 1965; Radkani and Saxe 2023).”
- 🔎 “When people allocate resources between themselves and another, they are attuned to their social partner’s perception of how the resources are divided (Houlihan et al. 2023), even when those perceptions are false (Baar, Chang, and Sanfey 2019).”

---

# Further reading

- 🔎 [[@2017sellGrammar]]: Shows that anger is a “recalibrational emotion” that functions to adjust how others value the angry individual’s welfare in the future; provides evidence that welfare-based negotiations occur in real human interactions.
- [[@2022andreEvolutionary]]: Argues that moral judgments can be explained as approximate solutions to the Nash [[Bargaining problems|bargaining problem]], which developed through evolutionary processes; gives a theory of the ultimate function of human moral psychology, but not necessarily its “proximate” psychological implementation.