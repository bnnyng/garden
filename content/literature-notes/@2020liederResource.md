...
>[!example] Key terms from [[@2020liederResource]]:
...
>- **Rational analysis** = a paradigm, notably developed by [[@1990andersonAdaptive]], that assumes human cognition is a *rational* adaptation to the environment’s structure and goals pursued within it, so that models of human behavior can be derived from formalizations of the environment.
