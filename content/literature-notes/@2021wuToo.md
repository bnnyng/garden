...
- Other studies using cooking tasks for multi-agent coordination involved **deep reinforcement learning**, which requires large amounts of pre-training experience.
- Previous studies of **ad-hoc coordination** focus on instantaneous action coordination, rather than across and within subtasks; the current study differs by applying Bayesian modeling to a decentralized multi-agent context.
