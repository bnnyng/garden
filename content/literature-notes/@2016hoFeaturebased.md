...
tags:
  - literature-note
lastmod: 2025-06-03T10:29:38-04:00
...
- **Inverse reinforcement learning:** for a single agent, inferring the goals or reward function of another agent based on observations of the latter’s behavior in an [[Markov decision processes and dynamic programming|MDP]].
...
- **Best-response models:** instead of reasoning about a **joint policy** directly, agents reason and plan individually by using a [[Markov decision processes and dynamic programming|transition function]] that includes a predictive model of another agent’s policy.
