...
- #queue Randal Bellistriero: [[Multilayer perceptrons|MLPs]] as a decomposition method, piecewise linear “cells” in the ambient space that are activated by specific input examples.
