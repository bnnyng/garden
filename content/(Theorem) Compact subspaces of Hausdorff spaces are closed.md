...
lastmod: 2024-11-03T10:38:05-05:00
---
>[!abstract] Theorem (26.3): Every compact subspace of a Hausdorff space is closed.

*Proof from [[MATH-GU4061|Modern Analysis I]].*

Let $X$ be [[Hausdorff spaces|Hausdorff]] and $K \subseteq X$ be [[Compactness|compact]]. We will show that $A$ is closed by showing that the complement $X \backslash K$ is open.
