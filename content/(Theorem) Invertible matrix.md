...
---
The invertible matrix theorem applies to two vector spaces with the same [[Vector bases and dimension|dimension]]. The theorem is built from facts relating [[Compositions and invertible linear maps|inverses]] and the [[Algebra of functions]]. We begin with the following proposition:
