...
lastmod: 2025-02-18T14:02:32-05:00
status: 🟡
---
# Overview

>[!example] Definition: Topology, topological space
>A **topology** on a set $X$ is a collection $\mathcal T$ of subsets of $X$  (i.e., a subset of the [[20250128-axioms-of-naive-set-theory|power set]] $\mathcal T \subseteq \mathcal P(X)$) that has the following properties:
...
Two points are **topologically indistinguishable** if they cannot be separated by open sets; the [[Hausdorff spaces|Hausdorff condition]] ensures that any two distinct points in a topological space are distinguishable.
...
**Related notes:** [[Topological categories and functors]]
