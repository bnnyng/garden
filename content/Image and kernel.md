...
The **image** and **kernel** are two [[Vector spaces and ring modules|subspaces]] associated with a [[Vector spaces and ring modules|linear map]].

---
# Images and kernels of linear maps

Let $A : V \to W$ be [[Vector spaces and ring modules|linear]].
...
- *(Lemma 46)* If $A : V \to W$ is [[Vector spaces and ring modules|linear]], then $\text{ker}(A) \subset V$ and $\text{im}(A) \subset W$ are indeed subspaces.
...
>Let $A : V \to W$ be [[Vector spaces and ring modules|linear]].
>- The **rank of $A$** is the [[Vector bases and dimension|dimension]] of its **image**; $\text{rank}(A) = \text{dim im} (A)$.
