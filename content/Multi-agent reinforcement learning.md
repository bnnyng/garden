...
lastmod: 2025-07-18T13:50:11-04:00
---
# Overview

$\quad$**Multi-agent reinforcement learning** is a [[§ Reinforcement Learning|reinforcement learning]] framework where independent agents pursue rewards in the same environment. MARL is formalized in [[Stochastic games|stochastic games]], where the typical action space of an MDP is replace by a **joint action space**, the product of individual agent action spaces.
