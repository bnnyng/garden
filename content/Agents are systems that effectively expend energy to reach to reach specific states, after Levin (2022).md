...
$\quad$Selves have the following basic properties: “the ability to **pursue goals**, to own **compound (e.g., associative) memories**, and to serve as the **locus for credit assignment** (be rewarded or punished), where all of these are at a scale larger than possible for any of its components alone.”
