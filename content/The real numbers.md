...
status: 🟡
---
The real numbers $\mathbb R$ have three defining properties: they are a [[Axiomatic definition of fields|field]] with defined operations of addition, scalar multiplication, and non-zero division; they are [[Order relations on sets and fields|ordered]]; and they have no "missing points." Informally, these properties make the real numbers visualizable as a line. 
...
>The [[Axiomatic definition of fields|field]] of **real numbers** is a tuple $(\mathbb R, + , \cdot, \leq)$ consisting of a set $\mathbb R$, the maps $+, \cdot : \mathbb R \times \mathbb R \to \mathbb R$ defined by
>$$
