...
lastmod: 2025-03-30T13:54:45-04:00
---
# Overview
...
>[!abstract] Theorem ([[MATH-GU4042|Modern Algebra II]] 3.4): Constructing larger fields to find polynomial roots
...
The key insight is that if $p$ is an [[Factorization on polynomial rings|irreducible]] factor of $f$ in $F[x]$, we can take $E = F[x] / (p)$ and $\alpha = x + (p)$, identifying $F$ with the subfield $\{ a + (p) \ : \  a \in F\}$ of $E$. 
...
>[!abstract] Corollary ([[MATH-GU4042|Modern Algebra II]] 3.5): Every irreducible factor of $f$ in the extension $E[x]$ is linear
...
>[!example] Definition: Transcendental, algebraic elements over a field
...
>[!abstract] Proposition: Smallest subfield of $E$ containing $F$ and $\alpha$
...
>[!example] Definition: Simple extension, generated over
