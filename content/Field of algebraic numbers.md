...
- $\overline{\mathbb Q}$ is not a [[Finite extension fields|finite extension]] of $\mathbb Q$, since it contains, for example, $$ \mathbb Q(\sqrt 2, \sqrt 3, \sqrt 5, \ldots ), $$ the smallest subfield of $\mathbb R$ which has the square roots of all the prime numbers, and hence of every positive integer.
