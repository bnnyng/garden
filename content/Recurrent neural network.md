...
Recurrent neural networks are specialized for sequential data. While a traditional [[Multilayer perceptrons|feedforward neural network]] has separate parameters for each input feature, an RNN shares weights across several time steps.
