...
lastmod: 2025-08-09T00:26:40-04:00
---
>[!theorem] Munkres 17.5: Describing the closure of a set using a topological basis
>Let $A$ be a subset of the [[Topological spaces and open sets|topological space]] $X$. Recall that $A, B$ **intersect** if $A \cap B \neq \varnothing$.
>- (i) A point $x \in X$ is in the [[Closed sets and closures|closure]] of $A$ $\iff$ every neighborhood of $x$ intersects $A$.
