...
lastmod: 2025-05-27T14:41:35-04:00
---
$\quad$ **Rational process models** help to connect [[Classical levels of cognitive theory|computational and algorithmic]] levels of analysis: the principle of [[Rationality in cognitive science|rationality]] at the *computational* level motivates algorithms that approximate probabilistic inference at the *algorithmic* and *implementational* levels. From [[@2024griffithsBayesian]]:
...
$\quad$ Rational process models assume that the mind *approximates* optimal inference and decision-making given constraints on time and computation. Here, rationality refers to the assumption that the algorithm used in cognition will converge to the optimal inference or decision as amounts of time and computation increase.

$\quad$ In contrast to rational process models, [[(Resource-)rational analysis|resource-rational analysis]] aims to uncover the *single* most effective approximation strategy, given constraints on time and computation.