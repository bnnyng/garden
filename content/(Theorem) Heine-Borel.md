...
lastmod: 2024-12-05T14:53:07-05:00
---
# In real analysis

>[!abstract] Theorem (Rudin 2.41): Heine-Borel
>Let $A\subseteq \mathbb R^n$. Then the following are equivalent:
>- (i) $A$ is [[Closed sets and closures|closed]] and [[Bounded sets and functions|bounded]];
...
>A [[Subspace (induced) topology|subspace]] $X \subseteq \mathbb R^n$ is [[Compactness|compact]] if and only if $X$ is [[Closed sets and closures|closed]] and [[Bounded sets and functions|bounded]] in the [[Topological spaces and open sets|standard topology]].
