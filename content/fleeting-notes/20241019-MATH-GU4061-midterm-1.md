...
lastmod: 2024-10-21T11:50:36-04:00
---
# Saturday, October 19
...
- [ ] Go over all significant proofs discussed in class
	...
	- [ ] Set is [[Open sets|open]] iff complement is [[Closed sets and closures|closed]]
	- [x] LPC $\implies$ SC
	- [ ] [[(Theorem) Extreme value|extreme value theorem]]
	- [ ] Continuous & compact implies uniformly continuous
...
- [ ] Go over homework problems (solutions?)
	- [x] 2.7 – Showing that $\sqrt 3$ is not rational by showing the sets of numbers greater/less than it have no sup/inf
	- [ ] 3.1 – Convexity
...
- General questions
	...
	- ❗ Why is the function induced by selecting $\delta$ for a continuous function on a compact set also continuous?