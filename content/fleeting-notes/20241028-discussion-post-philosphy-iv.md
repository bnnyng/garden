---
aliases:
  - "Discussion Post: Resource-Rational Analysis"
tags:
  - fleeting-note
  - PHIL-UN2655
date: 2024-10-28 00:41
lastmod: 2024-11-07T12:28:41-05:00
---
# Reading notes
...
The mistake of computationalism is to assume that a general theory of cognition must abstract away from individual cognitive systems (i.e., minds) and context; I think it is also fruitful to consider the relations between system and context, or properties of system-context pairs. It is particularly important to me that a cognitive science tells me clearly whether a thing I encounter is cognitive or not (I assume that this is a meaningful concept; as a very general starting point, my basic intuition is that it involves a certain level of complex, adaptive behavior with respect to an environment). Maybe what I’m getting at is an inside-out approach?

---
# Lecture notes: October 29

- Intermediate [[Classical levels of cognitive theory]]
	- Peacocke’s level 1.5 – how the computational level can draw information from the algorithmic; language, perception, etc appeal to information that needs to available but don’t specify (e.g., NP, VP in Chomskyan grammar, but doesn’t tell you the rules for production)
	- Where do representations fall? Suggests “lower” than the algorithm
- Vaporware 
	- Can’t specify something until you build it
	- Pseudo-code, abstract models
...
- Danks (2013) – Abstraction has dimensionality
	...
	- As long as we [[Linear combinations and spanning|span]] the space that is the world, it’s okay?
- Software and hardware problems are different
- Placebo and psychosomatic phenomena are selected for?
- Question:
	- Why do we care about the difference between 

---
# Lecture notes: October 31

- Supporting a scientific model with evidence
	- In the past: scientific knowledge should be deduced
	- Christiaan Huygens
- Problem of indiscriminate confirmation
	- Indiscriminate within model: model = hypothesis + auxiliary hypothesis; if model goes wrong, where was the problem?
	- Indiscriminate between models, multiple models making same predictions
- Adding epicycles (Fourier analysis = motion is compounding of circular motion)
	- Account for any planetary motion by adding epicycles to achieve arbitrary degree of accuracy
...
- Rational analysis avoids method of hypothesis (see above) by *deductively infer cognitive models from science + rationality assumption* – rather than make inferences about unobservable processes
	- Now *statistics* is the way to give evidence for scientific claims; in the method of hypothesis, statistics is the only form of scientific evidence
	- Newton disavowed method of hypothesis (in Principia); *deduced* the law of universal gravitation from evidence
	- Deductive inference is hard at beginning stages of a science
	- Data-driven science = data drives theory; make observation without hypothesis first
- Testing strategies that are appropriate for mature sciences (methods of hypothesis works if you have large body of theory) are not necessarily appropriate for immature
- Rationality = what should you do in a context?
- Resource-rational analysis
	- Do rational analysis; when people fall short, incorporate that into your model
	- When systems make the same mistakes, this is good evidence that systems work in the same way under the hood (BFG’s work is about why); when cognitive model replicates human mistakes, good evidence that cognitive model matches human behavior
	- BFG = this is entirely [[Top-down vs. bottom-up approaches to cognitive science|top-down]]
	- You can “de-abstract”/more fine-grained characterization further to account for differences e.g., psychological conditions