...
publish: "true"
date: 2024-04-22
lastmod: 2024-10-28T12:06:55-04:00
status: 🟡
---

>[!question]
>- Why is the definition of a limit point in topology the same as saying $x$ is a limit point if it is in the [[Closed sets and closures|closure]] of $A \backslash \{x\}$?
...
>A \cap (U \backslash \{x\}) \neq \varnothing.
>$$
>Equivalently, $x$ is a limit point if it is in the [[Closed sets and closures|closure]] of $A \backslash \{x\}$. We write $A’$ to denote the set of all limit points of $A$ in $X$.
