...
publish: "true"
lastmod: 2025-05-28T16:33:48-04:00
date: 2023-12-24
---
# Overview

$\quad$[[@1999clarkEmbodied]] draws a distinction between simple and radical theories of [[4E (embodied, embedded, extended, and enactive) cognition|embodied cognition]]:

- **Simple embodiment** assumes that cognitive systems are designed to operate on a physical world; that is, the physical world induces some constraints on mental [[Representation is describing some aspect of reality with a useful symbol|representations]];
...
- Understanding the relationship between intelligent systems, such as the [[Computationalist, connectionist, and rational research traditions in cognitive science|brain]], with the body and environment requires new analytical tools;
